...
```{r model_one, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r model_two , echo = FALSE, warning = FALSE, message = FALSE}
...
```{r model_three, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r model_four, echo = FALSE, warning = FALSE, message = FALSE}
